        ...
        <div class="content">
            <el-form ref="form" :rules="rules" :model="form" label-width="140px" v-if="!isDetails">
                 <el-form-item class="textareaBox" label="时间" >
                    ...
                    <TimeTab v-else time_type="week" :reportTime='reportTime' :isClick="isUpdate" font_color="#609ef7" v-on:data_time="day_data_time"></TimeTab>
                </el-form-item>
            ...
            <el-form  v-else :model="form" label-width="140px">
                <el-form-item class="textareaBox" label="时间" >
                    <TimeTab  time_type="week" font_color="#609ef7" :time="reportTime" :isClick="isUpdate" v-on:data_time="day_data_time"></TimeTab>
                </el-form-item>
                <el-form-item class="textareaBox" label="本周工作总结" >
                    <p v-html="form.summary"></p>
                </el-form-item>
                <el-form-item class="textareaBox" label="下周工作计划" >
