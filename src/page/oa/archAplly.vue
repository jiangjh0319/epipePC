    ...
    <div class="main">
        ...
        <div class="content">
            <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                <el-form-item label="借阅编号" prop="dossierBorrowNo"> 
                    <el-input v-model="form.dossierBorrowNo" readonly placeholder="请输入借阅编号" ></el-input>
                </el-form-item>
                <el-form-item label="借阅申请人" prop="browwUser"> 
                    <el-input v-model="form.userName" readonly placeholder="请输入借阅申请人" ></el-input>
                </el-form-item>
                <el-form-item label="所属部门"> 
                    <el-input v-model="form.departmentName" readonly placeholder="所属部门" ></el-input>
                </el-form-item>
                <el-form-item label="借阅名称" prop="browwName" > 
                    <el-input v-model="form.browwName" placeholder="请输入借阅名称" ></el-input>
                </el-form-item>
                ...
                <div v-for="(v,index) in form.list" :key="index">
                    ...
                    <el-form-item label="是否借纸质档" v-if="v.isShowRadio">  
                        <el-radio-group v-model="radio[index]" @change="changeRadio" size="mini">
                            <el-radio label="1" border>是</el-radio>
                            <el-radio label="0" border>否</el-radio>
                        </el-radio-group>
                        <!-- <el-radio v-model="radio[index]" label="1">是</el-radio>
                        <el-radio v-model="radio[index]" label="0">否</el-radio> -->
                    </el-form-item>
                </div>
                     <el-form-item> 
                        <el-button type="primary" round @click="addList">增加档案明细</el-button>
                    </el-form-item>
                <el-form-item class="textareaBox" label="借阅原因" prop="desc" >
                     <el-input  type="textarea" v-model="form.desc" maxlength="150" placeholder="请输入借阅原因">
                     </el-input>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                    browwName:[
                        { required: true, message: '借阅名称不能为空', trigger: 'blur' },
        ...
        created(){
            ...
            this.axios.get('work/dossierBorrowApply/no').then(res=>{
                ...
                if(res.data.h.code==200){
                    this.form.dossierBorrowNo = res.data.b.no;
                }else{
        ...
        methods:{
            ...
            submit(){
                ...
                approves = this.Util.approverFormat(this.allApprovers,this.linkAuditNum)
                 ...
                 params = {
                    Id :'', // id
                    dossierBorrowNo:that.form.dossierBorrowNo,//借阅编号
                    borrowReason : encodeURI(that.form.desc.replace(/\n/g, '<br/>')), //借阅原因
                    dossierBorrowNo:that.form.browwName,//借阅名称
                    dossierReturnDate:that.Util.getDate(that.form.returnDate),//时间
                ...
                console.log(params)
                // return
                that.axios.post(this.Service.saveDossierBorrowApply + this.Service.queryString(params)).then(function (res){
                if(res.data.h.code!=200){
